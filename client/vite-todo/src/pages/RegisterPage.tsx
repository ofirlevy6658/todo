...
const schema = yup
  .object({
    fullName: yup.string().min(2, 'Full name must be at least 2 characters').max(16).required(),
...
export const RegisterPage = () => {
  ...
  const registerMutate = useMutation({
    mutationFn: (credinatils: { fullName: string; email: string; password: string }) => registerReq(credinatils),
    onSuccess: (resp) => {
      console.log(resp);
    },
  });
        ...
        <Box sx={{ p: '35px' }}>
          ...
          <Box component={'form'} onSubmit={handleSubmit(onSubmit)} sx={{ mt: '25px' }}>
            ...
            <FormControl variant="standard" sx={{ mt: '10px' }}>
              ...
              <BootstrapInput id="fullname-input" placeholder="Jon Voight" {...register('fullName')} />
            ...
            <FormControl variant="standard" sx={{ mt: '10px' }}>
              ...
              <BootstrapInput id="password-input" placeholder="*******" {...register('password')} type="password" />
